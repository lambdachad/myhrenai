...
<section class="section-hero">
    <div class="container">
        ...
        <div class="hero-body">
            <div class="hero-desc">
                <p class="hero-p">
                    We build AI systems and automations that eliminate manual
                    busywork so your team stops wasting time on tasks that don't
                    grow the business.
                </p>
            </div>
                ...
                <div class="service-card">
                    ...
                    <div class="service-content">
                        ...
                        <p class="service-desc">
                            We connect your tools and eliminate the manual steps
                            between them. What took your team 4 hours now
                            happens in 4 seconds. Automatically.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="service-cell">
                <div class="service-card">
                    ...
                    <div class="service-content">
                        ...
                        <p class="service-desc">
                            Custom AI that handles customer inquiries, qualifies
                            leads, processes documents, and routes tasks. 24/7,
                            without breaks or bad days.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="service-cell">
                <div class="service-card">
                    ...
                    <div class="service-content">
                        ...
                        <p class="service-desc">
                            Your CRM doesn't talk to your invoicing tool. Your
                            project management tool doesn't update your client
                            portal. We make everything talk to everything.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="service-cell">
                <div class="service-card">
                    ...
                    <div class="service-content">
                        ...
                        <p class="service-desc">
                            Before we build anything, we find the bottleneck
                            hiding in your operations. The one costing you
                            thousands every month. Then we eliminate it.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="process-grid">
            <div class="process-cell">
                <div class="process-card">
                    ...
                    <p class="process-desc">
                        We map your workflows, find the bottlenecks, and
                        calculate exactly how much they're costing you. Free. No
                        obligation. If we can't help, we'll tell you.
                    </p>
                </div>
            </div>
            ...
            <div class="process-cell">
                <div class="process-card">
                    ...
                    <p class="process-desc">
                        Custom automations and AI systems tailored to your exact
                        process. No templates. No generic solutions. Built
                        specifically for the way your business operates.
                    </p>
                </div>
            </div>
            ...
            <div class="process-cell">
                <div class="process-card">
                    ...
                    <p class="process-desc">
                        We launch, monitor, and improve your systems over time.
                        When something breaks at 2 AM, we fix it, not you.
...
<section class="section-cta">
    <div class="container">
        ...
        <div class="cta-buttons">
            ...
            >
            <a href="mailto:contact@myhren.ai" class="btn-ghost cta-btn"
                >contact@myhren.ai</a
            >
        </div>
    </div>
        ...
        <div class="contact-grid">
            <div class="contact-sidebar">
                ...
                <div class="contact-links">
                    <a href="mailto:contact@myhren.ai" class="contact-email"
                        >contact@myhren.ai</a
                    >
                    <a
                        href="https://cal.com/myhrenai/strategy-call"
